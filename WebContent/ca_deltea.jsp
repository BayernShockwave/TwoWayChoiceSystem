...
<div id="mainmenu">
<h4 align="center">欢迎!!!请输入删除导师的导师号!!!</h4>
<div style="width:100%;text-align:center">
<form action="del_rs" method="post">
<input type="hidden" name="deltype" value="cadeltea">
导师号:<input type="text" id="userid" name="userid" placeholder="请输入导师号"/><br/>
导师学院:<input type="text" id="college" name="college" value="${param.college}" readonly/><br/>
<input type="submit" id="del" name="del" value="确认"/>
</form>
</div>
</div>
</div>
