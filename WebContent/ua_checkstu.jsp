...
for(Student stu:slist) {
	...
	out.println("<td>"+"<a href='check.action?userid="+stu.getUserid()+"&type=uadelstu'>删除</a>"+"</td>");
	out.println("<td>"+"<a href='check.action?userid="+stu.getUserid()+"&type=uaeditstu'>修改</a>"+"</td>");
	out.println("</tr>");
}
%>
</tbody>
