...
<div id="mainmenu">
<h4 align="center">欢迎!!!您可以修改学生的信息!!!</h4>
<form action="check.action" method="post">
<input type="hidden" name="type" value="caupdstu">
学生号:<input type="text" id="userid" name="userid" value="${sessionScope.userid}" readonly/><br/>
<%--用EL表达式代替String userid=(String)session.getAttribute("userid");--%>
...
学生学院:<input type="text" id="college" name="college" value="${sessionScope.college}" readonly/><br/>
<%--用EL表达式代替String college=(String)session.getAttribute("college");--%>
