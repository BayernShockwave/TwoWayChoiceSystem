...
<div id="mainmenu">
<h1 align="center">欢迎!!!您可查看或修改您的志愿选择情况!!!</h1>
<center>
...
for(Student stu:slist) {
	...
	out.println("<td>"+stu.getChoose1());
	out.println("<a href=\"stu_choose1_edit.jsp?college="+stu.getCollege()+"&teauserid="+stu.getChoose1()+"\">修改</a>"+"</td>");
	out.println("<td>"+stu.getChoose2());
	out.println("<a href=\"stu_choose2_edit.jsp?college="+stu.getCollege()+"&teauserid="+stu.getChoose2()+"\">修改</a>"+"</td>");
	out.println("<td>"+stu.getChoose3());
	out.println("<a href=\"stu_choose3_edit.jsp?college="+stu.getCollege()+"&teauserid="+stu.getChoose3()+"\">修改</a>"+"</td>");
	out.println("</tr>"); 
}
%>
</table>
