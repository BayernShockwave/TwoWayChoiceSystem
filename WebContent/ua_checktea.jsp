...
for(Teacher tea:tlist) {
	...
	out.println("<td>"+"<a href='check.action?userid="+tea.getUserid()+"&type=uadeltea'>删除</a>"+"</td>");
	out.println("<td>"+"<a href='check.action?userid="+tea.getUserid()+"&type=uaedittea'>修改</a>"+"</td>");
	out.println("</tr>");
}
%>
</tbody>
