...
<div id="mainmenu">
<h1 align="center">欢迎!!!您可以修改您的第二志愿导师!!!</h1>
<center>
...
for(Teacher tea:tlist) {
	if(!teauserid.equals(tea.getUserid())) {//此处不能直接使用teauserid!=tea.getUserid()
		out.println("<tr>");
		...
		out.println("<td>"+"<a href=\"stu_edit_rs.jsp?newuserid="+tea.getUserid()+"&olduserid="+teauserid+"\">确定修改</a>"+"</td>");
		out.println("</tr>"); 
	}
}
%>
